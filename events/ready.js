...
module.exports = client => {
  ...
  //online = çevrimiçi
  console.log(`                                                                                                                                                                     `)
  client.user.setActivity(`${prefix}yardım iyi dinlemeler.| ${client.guilds.size} sunucu | ${client.guilds.reduce((a, b) => a + b.memberCount, 0).toLocaleString()} Kullanıcıyı`, { type: "LISTENING"});
  //LISTENING = DİNLİYOR
  //WATCHING = İZLİYOR
  //PLAYING = OYNUYOR 
